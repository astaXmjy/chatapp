...
const ChatBox = () => {
  ...
  const scroll = useRef();
  // console.log("chatbox m messages: ", messages)
  // console.log("currentChat: ", currentChat)
  // console.log("recipientUser id: ", recipientUser?._id)
  ...
  return (
    <Stack gap={4} className="chat-box">
      ...
      <Stack direction="horizontal" gap={3} className="chat-input glex-grow-0">
        <InputEmoji
          value={textMessage}
